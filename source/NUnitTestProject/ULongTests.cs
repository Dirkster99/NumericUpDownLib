...
namespace NUnitTestProject
{
	...
	public class ULongTests
	{
		...
		public void TestValues()
		{
			...
			TestAllPermutations(0, 50, 75);
			TestAllPermutations(50, 50, 75);
			TestAllPermutations(50, 50, 50);
			TestAllPermutations(150, 150, 256);
		}
		...
		public void TestAllPermutations(ulong min, ulong val, ulong max)
		{
		...
		/// <returns></returns>
		bool IsValidRange(ULongUpDown range)
		{
