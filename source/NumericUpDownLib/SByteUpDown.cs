...
////                typeof(SByteUpDown), new PropertyMetadata(sbyte.MaxValue));
        ...
        /// <returns></returns>
        protected override bool OnIncrement(sbyte stepValue)
        {
            try
            {
                checked
                {
                    ...
                    var result = (sbyte)(Value + stepValue);
        ...
        /// <param name="stepValue"></param>
        /// <returns></returns>
        protected override bool OnDecrement(sbyte stepValue)
        {
            try
            {
                checked
        ...
        protected override sbyte CoerceMinValue(sbyte newValue)
        {
            ...
            sbyte result = Math.Min(Value, MaxValue);
        ...
        protected override sbyte CoerceMaxValue(sbyte newValue)
        {
            ...
            sbyte result = Math.Max(this.MinValue, newValue);
