namespace NumericUpDownLib
{
    ...
    public partial class ShortUpDown : AbstractBaseUpDown<short>
    {
        ...
        /// <returns></returns>
        protected override bool OnIncrement(short stepValue)
        {
            try
            {
                checked
                {
                    ...
                    var result = (short)(Value + stepValue);
        ...
        /// <param name="stepValue"></param>
        /// <returns></returns>
        protected override bool OnDecrement(short stepValue)
        {
            try
            {
                checked
        ...
        protected override bool VerifyText(string text, ref short tempValue)
        {
            if (short.TryParse(text, base.NumberStyle, CultureInfo.CurrentCulture, out short number))
            {
                tempValue = number;
